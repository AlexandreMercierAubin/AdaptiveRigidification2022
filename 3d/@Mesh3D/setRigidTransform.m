function  setRigidTransform( mesh3d, degrees, translation, forceCenterOfMassRotation )
...
%   degrees should be a 3 component vector axis x, y ,z
    ...
    mesh3d.p(1:3:end) = mesh3d.p(1:3:end) + translation(1);
    mesh3d.p(2:3:end) = mesh3d.p(2:3:end) + translation(2);
    mesh3d.p(3:3:end) = mesh3d.p(3:3:end) + translation(3);
